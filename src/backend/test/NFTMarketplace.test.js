...
describe("NFTMarketplace", function () {
  ...
  describe("Making marketplace items", function () {
    ...
    it("Should track newly created item, transfer NFT from seller to marketplace and emit Offered event", async function () {
      // aadr1 offers their nft at a price of 1 ether
      await expect(
      ...
      // Owner of NFT should now be the markeplact
  ...
  describe("Purchasing marketplace items", function () {
    ...
    beforeEach(async function () {
      ...
      await nft.connect(addr1).setApprovalForAll(marketplace.address, true);
      // addr1 makes their nft amarketplace item
    ...
    it("Should update item as sold, pay seller, transfer NFT to buyer, charge fees and emit a Bought event", async function () {
      ...
      // Seller should reciev payment for the price of the NFT sold
      expect(+fromWei(sellerFinalEthBal)).to.equal(
        +price + +fromWei(sellerInitalEthBal)
      );
      // feeAccount should recevie fee
    ...
    it("Should fail for invalid item ids, sold items and when not enough ether is paid", async function () {
      ...
      // In this instance, fails when buyer only sends enough ether to cover the price of the nft not the additional market fee.
      await expect(
